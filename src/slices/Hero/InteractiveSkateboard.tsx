...
const Scene = ({
  ...
  function front360(board: THREE.Group, origin: THREE.Group) {
    jumpBoard(board);
      ...
      <group ref={originRef}>
        <group ref={containerRef} position={[-0.25, 0, -0.635]}>
          <group position={[0, -0.086, 0.635]}>
            ...
            <Hotspot
              position={[0.1, 0.38, 1]}
              isVisible={!isAnimating && showHotspot.nose}
              color="#88FC39"
            />
            <mesh position={[0, 0.27, 0.9]} name="nose" onClick={onClick}>
            ...
            <Hotspot
              position={[0, 0.33, 0]}
              isVisible={!isAnimating && showHotspot.deck}
              color="#FF7A51"
            />
            <mesh position={[0, 0.27, 0]} name="deck" onClick={onClick}>
            ...
            <Hotspot
              position={[0, 0.34, -1]}
              isVisible={!isAnimating && showHotspot.tail}
              color="#46ACFA"
            />
            <mesh position={[0, 0.27, -0.9]} name="tail" onClick={onClick}>
              <boxGeometry args={[0.6, 0.2, 0.58]} />
              <meshStandardMaterial visible={false} color="red" />
            </mesh>
          </group>
