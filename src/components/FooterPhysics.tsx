...
export function FooterPhysics({
  ...
  useEffect(() => {
    ...
    // Create walls / boundaries around the scene to keeps boards in
    ...
    // Runner manages the animation loop and updates the engine 60 times per sec
